...
public class ViewSwitchBaseAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (null == view) {
            ...
            holder.iconImg = (ImageView) view.findViewById(R.id.img_video_info);
            holder.nameTv = (TextView) view.findViewById(R.id.textView);
            holder.imgSelectedSong = (ImageView) view.findViewById(R.id.img_choose_song);
            view.setTag(holder);
        } else {
