...
public class FloatWindowService extends Service implements View.OnClickListener,
    ...
    private View initFloatUI() {
        ...
        seekBarVideoProgress = (SeekBar) view.findViewById(R.id.video_progress);
        textVideoTime = (TextView) view.findViewById(R.id.video_time);
        textToggleVideoTime = (TextView) view.findViewById(R.id.video_toggle_time);
        videoControl = (RelativeLayout) view.findViewById(R.id.video_control);
